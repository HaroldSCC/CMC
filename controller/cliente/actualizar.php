...
if ($_POST)
{
	...
	try
	{
		...
		;
		$pst = $pdo->mysql->prepare("update Pnatural set nombre=:nombre,dian=:dian,cedula=:cedula,firmavirtual=:firmavirtual,fechavencimiento=:fechavencimiento,estado=:estado where id=:id");
